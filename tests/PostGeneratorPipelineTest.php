...
class PostGeneratorPipelineTest extends TestCase {
    ...
    protected function setUp(): void {
        ...
        $this->post_generator = new \AutoblogAI_Post_Generator(
            $this->api_client,
    ...
    public function test_post_generator_initialization() {
        $this->assertInstanceOf( 'AutoblogAI_Post_Generator', $this->post_generator );
    }
    ...
    public function test_banned_words_detection() {
        ...
        $this->assertEquals( 'autoblogai_banned_words_detected', $result->get_error_code() );
    }
    ...
    public function test_daily_cap_enforcement() {
        update_option( 'autoblogai_max_posts_per_day', 2 );
        ...
        $this->assertWPError( $result );
        $this->assertEquals( 'autoblogai_daily_cap_exceeded', $result->get_error_code() );
    }
    ...
    public function test_invalid_response_missing_field() {
        ...
        $this->assertWPError( $result );
        $this->assertEquals( 'autoblogai_invalid_response', $result->get_error_code() );
    }
